...
sudo lxc config device add web1 p4081 proxy listen=tcp:192.168.2.12:4081 connect=tcp:127.0.0.1:80
sudo lxc config device add web2 p4082 proxy listen=tcp:192.168.2.12:4082 connect=tcp:127.0.0.1:80

sudo lxc file push /vagrant/vistas/index_c2.html web1/var/www/html/index.html
sudo lxc file push /vagrant/vistas/index_c4.html web2/var/www/html/index.html
